...
class ImageEditor(QMainWindow):
    ...
    def create_toolbars(self):
        ...
        self.tool_bar.setObjectName("ToolsToolbar")
        ...
        for tool in DEFAULT_TOOL_REGISTRY:
            ...
            a = QAction(icon, tool.label, self)
            a.setToolTip(tool.label); a.setStatusTip(tool.label); a.setCheckable(True); a.setData(tool.tool_id)
    ...
    def create_panels(self):
        ...
        nd.setObjectName("NavigatorDock")
        ...
        hgd.setObjectName("HistogramDock")
    ...
    def create_job_status_widgets(self):
        ...
        self.job_progress.setAccessibleName("Image Job Progress")
        self.job_progress.hide()
        self.cancel_job_button = QPushButton("Cancel")
        self.cancel_job_button.setAccessibleName("Cancel Image Job")
